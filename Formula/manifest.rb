...
class Manifest < Formula
  ...
  url "https://github.com/fidenceio/manifest.cli/archive/refs/tags/v59.10.0.tar.gz"
  sha256 "82850626d03a4cb3aa928f7e13b4a04970f1f6d3ba4fa38994c972f595d45976"
  license "Apache-2.0"
  head "https://github.com/fidenceio/manifest.cli.git", branch: "main"

  bottle do
    root_url "https://github.com/fidenceio/homebrew-tap/releases/download/bottle-v59.10.0"
    sha256 cellar: :any, all: "e2dfd246dbcecddfe5aab7fff53f622050cc57b20bd84dbe9d16c996836ead92"
  end
