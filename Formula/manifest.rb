...
class Manifest < Formula
  ...
  url "https://github.com/fidenceio/manifest.cli/archive/refs/tags/v55.0.3.tar.gz"
  sha256 "aae6f45c810bd0c6fecc3de7f95134bcc94733a7103148341f30210beb606037"
  license "Apache-2.0"
  head "https://github.com/fidenceio/manifest.cli.git", branch: "main"

  bottle do
    root_url "https://github.com/fidenceio/homebrew-tap/releases/download/bottle-v55.0.3"
    sha256 cellar: :any, all: "4a1bd0875ab3d3cb3a86b537aff930659bc510bde256bff7b7e9cd451c90a70e"
  end
